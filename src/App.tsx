...
const apps: AppCard[] = [
  {
    ...
    color: 'amber',
    status: 'flagship',
    url: 'https://onepointec.com.au/QuoteStar/',
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-amber-50/30">
      ...
      >
        ...
        <nav className="p-4 space-y-1">
          ...
          <button className="flex items-center gap-3 w-full px-3 py-2 rounded-lg text-gray-600 hover:bg-gray-50 transition-colors">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-100">
          <button className="flex items-center gap-3 w-full px-3 py-2 rounded-lg text-gray-600 hover:bg-gray-50 transition-colors mb-2">
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-gradient-to-r from-amber-500 to-amber-600 rounded-2xl p-6 shadow-lg shadow-amber-200 text-white">
            <div className="flex items-center justify-between">
              ...
              <button
                onClick={() => window.open('https://onepointec.com.au/QuoteStar/', '_blank')}
                className="flex items-center gap-2 px-5 py-3 bg-white text-amber-600 rounded-xl font-semibold hover:bg-amber-50 transition-colors shadow-lg pulse-glow"
              >
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <button className="flex items-center gap-2 px-4 py-2 bg-amber-50 text-amber-700 rounded-lg font-medium hover:bg-amber-100 transition-colors border border-amber-200">
              ...
              {apps.map((app) => {
                ...
                return (
                  <div
                    ...
                    } p-5 shadow-sm hover:shadow-lg transition-all cursor-pointer group ${
                      colors.hover
                    }`}
                  >
                    ...
                    <div className="flex flex-wrap gap-1 mb-4">
                      {app.features.slice(0, 3).map((feature, idx) => (
                        <span
                          key={idx}
                          className={`text-xs px-2 py-1 rounded-md ${colors.badge}`}
                        >
                          {feature}
                        </span>
                      ))}
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      >
                        {app.status === 'flagship' ? 'Open App →' : app.status === 'premium' ? 'Unlock Access' : 'Available'}
                      </span>
                      <ChevronRight
          ...
          <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 rounded-2xl p-6 shadow-xl">
            <div className="flex items-center justify-between">
              ...
              <button className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-amber-400 to-amber-600 text-white rounded-xl font-semibold hover:from-amber-500 hover:to-amber-700 transition-all shadow-lg hover:shadow-xl">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl">
            ...
            <div className="flex items-center gap-4 mb-6 p-4 bg-gray-50 rounded-xl">
              <div
                className={`h-14 w-14 rounded-xl ${colorMap[upgradeApp.color as keyof typeof colorMap].bg} flex items-center justify-center`}
              >
            ...
            <div className="bg-amber-50 rounded-xl p-4 mb-6 border border-amber-200">
              <div className="flex items-center justify-between">
                ...
                <span className="text-2xl font-bold text-amber-600">$49<span className="text-sm font-normal text-gray-500">/mo</span></span>
              </div>
            ...
            <div className="flex gap-3">
              ...
              <button className="flex-1 px-4 py-3 bg-gradient-to-r from-amber-400 to-amber-600 text-white rounded-xl font-semibold hover:from-amber-500 hover:to-amber-700 transition-all shadow-lg">
                Upgrade Now
              </button>
            </div>
          </div>
